...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pengiriman', function (Blueprint $table) {
            ...
            $table->string('no_invoice', 255)->unique()->nullable(false);
            $table->datetime('tgl_kirim');
            $table->datetime('tgl_tiba')->nullable();
            $table->enum('status_kirim', ['Sedang Dikirim', 'Tiba Di Tujuan']);
            $table->string('nama_kurir', 30)->nullable(false);
            $table->string('telpon_kurir', 15)->nullable(false);
            $table->string('bukti_foto', 255)->nullable(true);
