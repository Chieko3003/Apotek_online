            ...
            <div class="owl-carousel nonloop-block-13">
              <div class="testimonial-3 d-flex">
                <div class="vcard-wrap mr-5">
                  <img src="{{asset('frontend/images/person_1.jpg')}}" alt="Image" class="vcard img-fluid">
                </div>
                <div class="text">
                  <h3>Jeff Woodland</h3>
              ...
              <div class="testimonial-3 d-flex">
                <div class="vcard-wrap mr-5">
                  <img src="{{asset('frontend/images/person_3.jpg')}}" alt="Image" class="vcard img-fluid">
                </div>
                <div class="text">
                  <h3>Jeff Woodland</h3>
                  <p class="position">Partner</p>
              ...
              <div class="testimonial-3 d-flex">
                <div class="vcard-wrap mr-5">
                  <img src="{{asset('frontend/images/person_2.jpg')}}" alt="Image" class="vcard img-fluid">
                </div>
                <div class="text">
                  <h3>Jeff Woodland</h3>
                  <p class="position">Partner</p>
  ...
  <div class="site-section py-5 bg-warning">
    <div class="container">
      <div class="row justify-content-center">
        ...
        <h2 class="text-white m-0">Keluarga sehat hari haripun ceria</h2>
        <a href="{{route('Store.index')}}" class="btn btn-primary btn-custom-1 py-3 px-5 ml-auto">Lihat Semua</a>
        </div>
      </div>
    </div>
  </div>