        ...
        <form action="{{ route('profile.update') }}" method="POST" id="profileForm">
            ...
            <div class="form-group">
                ...
                <select name="jabatan" id="jabatan" class="form-control" required>
                    ...
                    <option value="owner" {{ auth()->user()->jabatan == 'karyawan' ? 'selected' : '' }}>Karyawan</option>
                    <option value="user" {{ auth()->user()->jabatan == 'pemilik' ? 'selected' : '' }}>Pemilik</option>
                    <option value="user" {{ auth()->user()->jabatan == 'store' ? 'selected' : '' }}>Store</option>
                    <option value="user" {{ auth()->user()->jabatan == 'apoteker' ? 'selected' : '' }}>Apoteker</option>
                </select>
            </div>
